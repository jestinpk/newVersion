  ...
  return (
    <SubpageShell eyebrow="Downloads" title="Project resources" intro="Access available PK LIGHTS catalogues and design resources from the existing downloads service.">
      <section className="info-content">
        ...
        <div className="download-note"><b>Can’t find a product file?</b><p>Send the product name or photo on WhatsApp. We can confirm whether a catalogue, specification sheet or design file is available.</p><a href="/newVersion/quote.html">Ask for a product file →</a></div>
      </section>
    </SubpageShell>
  );
}
